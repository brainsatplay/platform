...
const brainstorm = require('./src/backend/brainstorm/Brainstorm')
const createAppletManifest = require('./src/common/createAppletManifest')
// const createPluginManifest = require('./src/backend/createPluginManifest')
...
// Set Routes
let initRoutes = require("./src/backend/routes/web")
initRoutes(app);
