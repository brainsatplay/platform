...
;// CONCATENATED MODULE: ./src/utils/ObjectListener.js
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
;// CONCATENATED MODULE: ./src/utils/StateManager.js
...
var Events = /*#__PURE__*/function () {
  ...
  Event_createClass(Events, [{
    ...
    value: function emit(eventName, input) {
      ...
      var transfer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
      var port = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
      var output = {
        eventName: eventName,
        output: input
      };
      ...
      if (this.workermanager !== undefined) {
        ...
        if (workerId !== undefined) this.workermanager.postToWorker(output, workerId, transfer);else {
          this.workermanager.workers.forEach(function (w) {
            _this3.workermanager.postToWorker(output, w.id, transfer);
          });
        }
      } else if (typeof WorkerGlobalScope !== 'undefined' && self instanceof WorkerGlobalScope) {
        // run this in global scope of window or worker. since window.self = window, we're ok
        //if(port) console.log(port,output);
        if (port) port.postMessage(output, undefined, transfer);else postMessage(output, undefined, transfer); //thread event 
      }
...
var ElementProxyReceiver = /*#__PURE__*/function (_EventDispatcher) {
  _inherits(ElementProxyReceiver, _EventDispatcher);

  var _super = _createSuper(ElementProxyReceiver);

  function ElementProxyReceiver() {
    var _this;

    _classCallCheck(this, ElementProxyReceiver);

    _this = _super.call(this); // because OrbitControls try to set style.touchAction;

    _this.style = {};
    return _this;
  }

  _createClass(ElementProxyReceiver, [{
    key: "clientWidth",
    get: function get() {
      return this.width;
    }
  ...
  return ElementProxyReceiver;
}(EventDispatcher); /////////////https://threejsfundamentals.org/threejs/lessons/threejs-offscreencanvas.html

var ProxyManager = /*#__PURE__*/function () {
  ...
  _createClass(ProxyManager, [{
    key: "makeProxy",
    value: function makeProxy(data) {
      var id = data.id;
...
// EXTERNAL MODULE: ./src/utils/workers/gpu/gpu-browser.min.js
var gpu_browser_min = __webpack_require__(732);
;// CONCATENATED MODULE: ./src/utils/workers/gpu/gpuUtils-functs.js
...
;// CONCATENATED MODULE: ./src/utils/workers/gpu/gpuUtils.js
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
/* harmony export */ });
/* harmony import */ var _gpu_gpuUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(795);
/* harmony import */ var _Math2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(809);
/* harmony import */ var _Event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(387);
/* harmony import */ var _ProxyListener_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(163);
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
 ...
 // must include or webpack breaks
...
function parseFunctionFromText(method) {
  ...
  if (newFuncHead.includes('function ')) {
    ...
    if (newFuncHead.substring(0, 6) === newFuncBody.substring(0, 6)) {
      ...
      var _varName = newFuncHead.split('(')[1].split(')')[0]; //console.log(varName, newFuncHead ,newFuncBody);

      newFunc = new Function(_varName, newFuncBody.substring(newFuncBody.indexOf('{') + 1, newFuncBody.length - 1));
...
var CallbackManager = /*#__PURE__*/function () {
  function CallbackManager() {
    ...
    try {
      window.gpu = new _gpu_gpuUtils__WEBPACK_IMPORTED_MODULE_0__/* .gpuUtils */ .T9();
      this.gpu = window.gpu;
    } catch (_unused) {
      var gpu = new _gpu_gpuUtils__WEBPACK_IMPORTED_MODULE_0__/* .gpuUtils */ .T9();
      this.gpu = gpu;
    }
    ...
    this.PROXYMANAGER = new _ProxyListener_js__WEBPACK_IMPORTED_MODULE_4__/* .ProxyManager */ .LG();
    ...
    this.callbacks = [{
      ...
      "case": 'ping',
      callback: function callback(self, args, origin) {
        return 'pong';
      }
    }, {
      ...
      callback: function callback(self, args, origin) {
        ...
        var response = parseFunctionFromText(args[1]);

        var eventSetting = _this.checkEvents(args[0]); //this will contain the port setting if there is any
        //console.log(args, eventSetting)


        return self.EVENTS.subEvent(args[0], function (output) {
          response(self, output, origin, eventSetting === null || eventSetting === void 0 ? void 0 : eventSetting.port, eventSetting === null || eventSetting === void 0 ? void 0 : eventSetting.eventName); //function wrapper so you can access self from the event subscription
        });
      }
    }, {
      ...
      callback: function callback(self, args, origin) {
        if (args.type === 'makeProxy') {
          ...
          var proxy = self.PROXYMANAGER.getProxy(args.id);
      ...
      "case": 'initThree',
      callback: function () {
        var _callback = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(self, args, origin) {
          var module;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 7:
                  ...
                  _context2.next = 10;
                  return _this.runCallback('setValues', args[1]);
      ...
      "case": 'startThree',
      callback: function () {
        var _callback2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(self, args, origin) {
          var module;
      ...
      callback: function callback(self, args, origin) {
        ...
        if (_this.threeUtil) {
          _this.threeUtil.clear(self, args, origin);
        }
      ...
      callback: function callback(self, args, origin) {
        ...
        var anim = function anim() {
          if (self.ANIMATING) {
            ...
            var emitevent = self.checkEvents('render', origin);
            var dict = {
              foo: 'render',
      ...
      callback: function callback(self, args, origin) {
        ...
        self.animationFunc(self, args, origin);
        var time = performance.now() - self.ANIMFRAMETIME;
      ...
      "case": 'xcor',
      callback: function callback(self, args, origin) {
        return _Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2.crosscorrelation.apply */ .d.crosscorrelation.apply(_Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2 */ .d, _toConsumableArray(args));
      }
    }, {
      "case": 'autocor',
      callback: function callback(self, args, origin) {
      ...
      "case": 'cov1d',
      callback: function callback(self, args, origin) {
        return _Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2.cov1d.apply */ .d.cov1d.apply(_Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2 */ .d, _toConsumableArray(args));
      }
    }, {
      "case": 'cov2d',
      callback: function callback(self, args, origin) {
      ...
      "case": 'sma',
      callback: function callback(self, args, origin) {
        return _Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2.sma.apply */ .d.sma.apply(_Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2 */ .d, _toConsumableArray(args));
      }
    }, {
      "case": 'dft',
      callback: function callback(self, args, origin) {
        ...
        return (_self$gpu = self.gpu).gpuDFT.apply(_self$gpu, _toConsumableArray(args));
      }
    }, {
      "case": 'multidft',
      callback: function callback(self, args, origin) {
        ...
        if (args[2] == undefined) args[2] = 1;
        return (_self$gpu2 = self.gpu).MultiChannelDFT.apply(_self$gpu2, _toConsumableArray(args));
      }
    }, {
      ...
      callback: function callback(self, args, origin) {
        ...
        return (_self$gpu3 = self.gpu).MultiChannelDFT_Bandpass.apply(_self$gpu3, _toConsumableArray(args));
      }
    }, {
      "case": 'fft',
      callback: function callback(self, args, origin) {
        ...
        if (args[2] == undefined) args[2] = 1;
        return (_self$gpu4 = self.gpu).gpuFFT.apply(_self$gpu4, _toConsumableArray(args));
      }
    }, {
      "case": 'multifft',
      callback: function callback(self, args, origin) {
        ...
        if (args[2] == undefined) args[2] = 1;
        return (_self$gpu5 = self.gpu).MultiChannelFFT.apply(_self$gpu5, _toConsumableArray(args));
      }
    }, {
      ...
      callback: function callback(self, args, origin) {
        ...
        if (args[4] == undefined) args[4] = 1;
        return (_self$gpu6 = self.gpu).MultiChannelFFT_Bandpass.apply(_self$gpu6, _toConsumableArray(args));
      }
    }, {
      "case": 'gpucoh',
      callback: function callback(self, args, origin) {
        ...
        return (_self$gpu7 = self.gpu).gpuCoherence.apply(_self$gpu7, _toConsumableArray(args));
      }
    }, {
      "case": 'coherence',
      callback: function callback(self, args, origin) {
        var correlograms = _Math2__WEBPACK_IMPORTED_MODULE_1__/* .Math2.correlograms */ .d.correlograms(args[0]);
  ...
  _createClass(CallbackManager, [{
    key: "runCallback",
    value: function () {
      var _runCallback = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(foo) {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                input = _args5.length > 1 && _args5[1] !== undefined ? _args5[1] : [];
                origin = _args5.length > 2 ? _args5[2] : undefined;
                output = 'function not defined';
                _context5.next = 5;
                return Promise.all(this.callbacks.map( /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(o, i) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            _context4.next = 4;
                            return o.callback(_this2, input, origin);
      ...
      function runCallback(_x8) {
        return _runCallback.apply(this, arguments);
      }
    ...
    value: function checkEvents(foo, origin) {
      var found = this.EVENTSETTINGS.find(function (o) {
        if (o.origin && origin && o["case"] && foo) {
          if (o.origin === origin && o["case"] === foo) return true;else return false;
        } else if (o["case"] && foo) {
          if (o["case"] === foo) return true;else return false;
    ...
    key: "checkCallbacks",
    value: function () {
      var _checkCallbacks = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(event) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                _context7.next = 5;
                return Promise.all(this.callbacks.map( /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(o, i) {
                      ...
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          case 0:
                            ...
                            _context6.next = 4;
                            return o.callback(_this3, event.data.input, event.data.origin);
                          ...
                          case 7:
                            ...
                            _context6.next = 10;
                            return o.callback(_this3, event.data.args, event.data.origin);
      ...
      function checkCallbacks(_x11) {
        return _checkCallbacks.apply(this, arguments);
      }
...
self.onmessage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var input, dict, output, emitted, eventSetting, transfer, _output$__proto__, _output$__proto__$__p, _output$constructor, key, _output$key$__proto__, _output$key$__proto__2;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            eventSetting = manager.checkEvents(input.foo, input.origin); //console.log(event)

            _context.next = 13;
            return manager.checkCallbacks(event);
          ...
          case 13:
            ...
            if (output) {
              if (((_output$__proto__ = output.__proto__) === null || _output$__proto__ === void 0 ? void 0 : (_output$__proto__$__p = _output$__proto__.__proto__) === null || _output$__proto__$__p === void 0 ? void 0 : _output$__proto__$__p.constructor.name) === 'TypedArray') {
                transfer = [output.buffer];
              } else if (((_output$constructor = output.constructor) === null || _output$constructor === void 0 ? void 0 : _output$constructor.name) === 'Object') {
                for (key in output) {
                  if (((_output$key$__proto__ = output[key].__proto__) === null || _output$key$__proto__ === void 0 ? void 0 : (_output$key$__proto__2 = _output$key$__proto__.__proto__) === null || _output$key$__proto__2 === void 0 ? void 0 : _output$key$__proto__2.constructor.name) === 'TypedArray') {
